...
public class ArtificialImmuneSystemKnapsack : IKnapsackAlgorithm
    {
        ...
        public ArtificialImmuneSystemKnapsack(List<(int, int)> items, int knapsackCapacity, int populationSize, int maxIterations)
        {
            _items = items;
        ...
        private List<int> Mutate(List<int> solution)
        {
            Random rand = new Random();
        ...
        private List<List<int>> PerformClonalSelection(List<List<int>> population, int clonesPerAntibody)
        {
